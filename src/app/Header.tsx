  ...
  return (
    <header>
      ...
      <ol className="flex justify-center gap-4 mb-3 border-b-2 border-b-gray-400">
        <li className="text-center text-gray-500 dark:text-gray-300 relative after:content[''] after:absolute after:top-1/2 after:translate-x-[calc(0.5rem-1px)] after:-translate-y-1/2 after:w-px after:h-4/5 after:bg-gray-400">
          {currentPath === "/" ? (
            "Sessions"
          ) : (
